use inkpaper_ui::{FontData, FontRegistryError, FontWeight, ResourceRuntimeApi, TtfFont};
...
pub(crate) fn register<'resource>(
    ...
    runtime.register_font_face(family, FontWeight::NORMAL, &UI_REGULAR_FONT)?;
    runtime.register_font_face(family, FontWeight::BOLD, &UI_BOLD_FONT)?;
